...
int main(int argc, char *argv[])
{
    ...
    {
        YOMK_INFO_TAG("TestYomkROS2Topic", "[PASS] YOMKROS2_NODE");
        g_pass++;
    }
    ...
    {
        YOMK_INFO_TAG("TestYomkROS2Topic", "[RECV] ", msg->data);
    };
    ...
    {
        YOMK_INFO_TAG("TestYomkROS2Topic", "[PASS] YOMKROS2_SUB_TOPIC");
        g_pass++;
    }
    ...
    {
        YOMK_INFO_TAG("TestYomkROS2Topic", "[PASS] YOMKROS2_PUB_TOPIC");
        g_pass++;
    }
    ...
    if (runReturned)
    {
        YOMK_INFO_TAG("TestYomkROS2Topic", "[PASS] YOMKROS2_RUN(true) returned after signal");
        g_pass++;
    }
    else
    {
    ...
    {
        YOMK_INFO_TAG("TestYomkROS2Topic", "[PASS] YOMKROS2_SHUTDOWN");
        g_pass++;
    }
